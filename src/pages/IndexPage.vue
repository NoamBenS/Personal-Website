...
const skills = [
  {
    ...
    iconImages: [
      ...
      '/icons/techicons/c.png',
      '/icons/techicons/html.png',
  ...
  {
    label: 'Frameworks',
    icons: ['Vue', 'Quasar', 'Next.js', 'Wordpress'],
    iconImages: [
      '/icons/techicons/vue.png',
      '/icons/techicons/quasar.png',
      '/icons/techicons/next.png',
      '/icons/techicons/wordpress.png',
    ],
    background: 'white',
  },
  {
